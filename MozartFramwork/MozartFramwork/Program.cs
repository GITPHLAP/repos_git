...
namespace MozartFramwork
{
    class Program
    {
        static void Main(string[] args)
        {
            System.Media.SoundPlayer sp = new System.Media.SoundPlayer();// Declare musik afspilleren
            Random rndnumbertodice = new Random();//declare en random 
            //opretter tabelen for minuetten
            int[,] minuettabel = {
                ...
                {9,56,132,34,125,39,175,166,82,164,92},//12
            ...
            //Udskriver minutten 16 gange
            Console.WriteLine("Minuetten");
            for (int i = 0; i < 16; i++)
            {
                //ruller terningerne
                int dice1 = rndnumbertodice.Next(1, 7);
                int dice2 = rndnumbertodice.Next(1, 7);
                //udskriver hvilken fil det er
                Console.WriteLine(minuettabel[i, (dice1 + dice2 -2)]);
                sp.SoundLocation = @"C:\Users\kjedt\Desktop\Skole\Wave\M" + minuettabel[i, (dice1 + dice2-2)] + ".wav";
                sp.Load();
                sp.PlaySync();
            ...
            {
                int dice1 = rndnumbertodice.Next(1, 7);
                Console.WriteLine(trioTable[i, dice1-1]);
                sp.SoundLocation = @"C:\Users\kjedt\Desktop\Skole\Wave\T" + trioTable[i, dice1-1] + ".wav";
                sp.Load();
                sp.PlaySync();
            }
            Console.WriteLine("Endelig fred!!!!");
        }
    }
}
